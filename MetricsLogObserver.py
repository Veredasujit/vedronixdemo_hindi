...
from pipecat.observers.loggers.metrics_log_observer import (
    MetricsLogObserver as PipecatMetricsLogObserver,
)


class MetricsLogObserver(PipecatMetricsLogObserver):
    """Local metrics observer class exposed from user's file."""
